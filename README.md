...
- [常用的 LaTeX 數學語法](https://class.kh.edu.tw/19061/bulletin/msg_view/592)、[Latex教學](http://www.cs.nthu.edu.tw/~cherung/teaching/2009cs5321/link/latex.pdf)、[Latex語法筆記](https://hackmd.io/8EghvbedRr6aRNX5tMJnfA?both)、[常用 LaTeX 數學符號指令](https://hackmd.io/@CynthiaChuang/Basic-LaTeX-Commands)
